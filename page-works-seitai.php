...
<head>
  ...
  <title>整体院のサイトリニューアル | MIMDESIGN 制作事例</title>
  <meta name="description" content="情報設計・コンテンツ構成設計・デザイン・実装まで一貫担当した整体院サイトリニューアルの制作事例。来院前の不安解消と予約導線の改善。">
  <meta property="og:type" content="article">
  <meta property="og:site_name" content="MIMDESIGN">
  <meta property="og:title" content="整体院のサイトリニューアル | MIMDESIGN 制作事例">
  <meta property="og:description" content="情報設計・コンテンツ構成設計・デザイン・実装まで一貫担当した整体院サイトリニューアルの制作事例。来院前の不安解消と予約導線の改善。">
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:title" content="整体院のサイトリニューアル | MIMDESIGN 制作事例">
  <meta name="twitter:description" content="情報設計・コンテンツ構成設計・デザイン・実装まで一貫担当した整体院サイトリニューアルの制作事例。来院前の不安解消と予約導線の改善。">
...
<body>
      ...
      <div class="works-hero-inner">
        <div class="works-hero-content">
          <div class="works-breadcrumb">
            ...
            <span class="works-breadcrumb-sep">›</span>
            <span>整体院のサイトリニューアル</span>
          </div>
          <span class="works-category-badge">医療・整体 / Web制作</span>
          <h1 class="works-title">整体院の<br>サイトリニューアル</h1>
          <p class="works-subtitle">来院前の不安を解消し、予約・問い合わせを増やす情報設計</p>
          <a href="https://takeuchi-syugi.net/index.html" target="_blank" rel="noopener" class="works-site-link">
            公開サイトを見る
        ...
        <div class="works-hero-img">
          <img src="<?php echo get_template_directory_uri(); ?>/assets/img/seitaiin.webp" alt="整体院のサイトリニューアル — 制作実績">
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="works-info-grid" style="max-width:var(--container-max);margin:0 auto;padding:0 var(--container-px);">
      <div class="works-info-item">
        ...
        <div class="works-info-tags">
          <span class="works-info-tag">医療・整体</span>
      ...
      <div class="works-info-item">
        ...
        <div class="works-info-tags">
          ...
          <span class="works-info-tag">コンテンツ構成設計</span>
          <span class="works-info-tag">デザイン</span>
      ...
      <div class="works-info-item">
        ...
        <div class="works-info-tags">
          ...
          <span class="works-info-tag">WordPress</span>
        </div>
      </div>
      <div class="works-info-item">
        <span class="works-info-label">Link</span>
        <div class="works-info-tags">
          <a href="https://takeuchi-syugi.net/index.html" target="_blank" rel="noopener" class="works-info-tag">公開サイト ↗</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <section class="section section-light">
    <div class="container works-content-wrap">
      ...
      <p class="works-section-text">
        整体院のWebサイトリニューアルを担当。情報設計・コンテンツ構成設計・デザイン・実装まで一貫対応しました。<br><br>
        「根本改善」をコアメッセージに据え、施術への理解・信頼感・予約への行動がスムーズに流れるサイト設計を実現。長年の腰痛・肩こりに悩む30〜60代のユーザーに対して、来院前の不安を解消し、問い合わせ・予約へ誘導する構成を追求しました。
      </p>
  ...
  <section class="section section-dark">
    <div class="container works-content-wrap">
      ...
      <ul class="works-list">
        <li>「どんな施術をしているのか」が伝わりにくいページ構成</li>
        <li>初めて来院する人に向けた安心感の設計が不足していた</li>
        <li>施術メニューと料金が分かりにくく、問い合わせへの障壁が高かった</li>
        <li>スマホ対応が不十分で、ファーストビューの訴求力が低かった</li>
      </ul>
    </div>
  </section>
  ...
  <section class="section section-light">
    <div class="container works-content-wrap">
      ...
      <ul class="works-list">
        <li>「来院の流れ」セクションを追加し、初めての人が不安なく予約できる構成に</li>
        <li>施術メニューをカード型UIで整理し、視覚的に比較しやすく</li>
        <li>FVに「どんな悩みに対応しているか」を明記し、ターゲットに刺さるファーストビューを設計</li>
        <li>口コミ・実績をファーストビュー近くに配置し、信頼性を早期に担保</li>
      </ul>
    </div>
  </section>
  ...
  <section class="section section-offwhite">
    <div class="container works-content-wrap">
      ...
      <ul class="works-list">
        <li>「根本改善」という言葉をコアメッセージとして全体を統一</li>
        <li>施術前後の変化が伝わるような体験談セクションを充実</li>
        <li>予約・問い合わせボタンをヘッダー固定とフッターの2箇所に設置し、いつでも行動できる設計</li>
        <li>整体院らしい落ち着いた配色（深緑・白・ベージュ）を採用し、信頼感と清潔感を表現</li>
        <li>スマホからの閲覧を最優先にレイアウトを設計</li>
      </ul>
    </div>
  </section>
